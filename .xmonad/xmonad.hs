...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,               xK_j     ), windows W.focusDown)   -- focus next window
    , ((modm,               xK_k     ), windows W.focusUp)     -- focus previous window
    , ((modm,               xK_m     ), windows W.focusMaster) -- focus master window

    -- Swap windows
    , ((modm .|. shiftMask, xK_j     ), windows W.swapDown)   -- swap with next
    , ((modm .|. shiftMask, xK_k     ), windows W.swapUp)     -- swap with prev
    ...
    -- System
    , ((modm .|. shiftMask, xK_q     ), io (exitWith ExitSuccess))  -- quit
